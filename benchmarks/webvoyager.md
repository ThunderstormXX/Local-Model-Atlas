...
WebVoyager evaluates multimodal web agents on real websites.

## What It Measures

Visual web grounding, browser actions, and task completion.

## Evaluation

Agents complete web tasks; published results report success rate.

Official leaderboard or source: [https://github.com/MinorJerry/WebVoyager](https://github.com/MinorJerry/WebVoyager)

## Source Coverage

| Source | Type | Parser |
| ------ | ---- | ------ |
| [WebVoyager repository](https://github.com/MinorJerry/WebVoyager) | repository | cache_only |
